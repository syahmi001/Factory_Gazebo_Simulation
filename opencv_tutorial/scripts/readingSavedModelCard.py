...
parser.add_argument('--image_path', help="Path of image to detect objects", default=r'/home/user/catkin_ws/src/opencv_ros_tutorial/lena.png')
parser.add_argument('--verbose', help="To print statements", default=True)
args = parser.parse_args()


def load_yolo():
    net = cv2.dnn.readNet(r"/home/user/catkin_ws/src/opencv_ros_tutorial/yolo_model/yolov3.weights", r"/home/user/catkin_ws/src/opencv_ros_tutorial/yolo_model/yolov3.cfg")
    classes = []
    with open(r"/home/user/catkin_ws/src/opencv_ros_tutorial/yolo_model/coco.names", "r") as f:
